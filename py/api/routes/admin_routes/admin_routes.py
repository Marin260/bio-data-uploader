...
def block_user(user_id: int, user_queries: UserQueries = Depends(user_repo)):
    blocked_user = user_queries.block_user(user_id)
...
def unblock_user(user_id: int, user_queries: UserQueries = Depends(user_repo)):
    unblocked_user = user_queries.unblock_user(user_id)
...
def delete_user(user_id: int, user_queries: UserQueries = Depends(user_repo)):
